...
To purchase TAO and use it using a mobile device, you will need `NOVA` wallet. See their website for downloads [here](https://novawallet.io/).
NOVA Wallet is the only app we've found that successfully integrates polkadot web interactions with a mobile held wallet.

&nbsp;

We will be purchasing TAO using USDT (since it's the only market they offer) from mexc.com

NOTE: For US located people, you will need a VPN enabled due to TAO being geo-blocked on MEXC. You'll find resources for optimal VPNs [here](https://northtensor.ai/docs/using-vpn).
...
## If you want to purchase USDT with a credit card follow this--if not skip to the next section: {#credit-card-usdt}
...
Follow the instructions, and input your TAO address from your NOVA or polkdadot.js wallet.
