...
After creating an account with your VPN provider of choice, connect to a new location (Singapore is commonly recommended) and follow the same steps outlined in our [guide on how to purchase tao](https://northtensor.ai/docs/purchase-tao) to make a purchase on MEXC.