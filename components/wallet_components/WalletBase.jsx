...
{(currentAccount != null && currentAccount.source == 'polkadot' && fullStakeAmount > 0) ? 
      ...
      {(currentAccount != null && currentAccount.source == 'polkadot' && fullStakeAmount > 0) ?
        <div className="relative" style={{ display: "flex", justifyContent: "space-evenly" }}>
          { (isValidFloat(stakeAmount) && parseFloat(stakeAmount) > 0 && parseFloat(stakeAmount) / 10**9 < fullStakeAmount / 10**9) ? 
          <TxButton
          label="Stake"
          type="SIGNED-TX"
          setStatus={setStatus}
      ...
      {(currentAccount != null && currentAccount.source == 'polkadot' && amountCurrentlyStaked > 0) ?
        <div className="relative" style={{ display: "flex", justifyContent: "space-evenly" }}>
          { (isValidFloat(unstakeAmount) && parseFloat(unstakeAmount) > 0 && parseFloat(unstakeAmount) / 10**9 < amountCurrentlyStaked / 10**9) ? 
          <TxButton
          label="Un-Stake"
          type="SIGNED-TX"
          setStatus={setStatus}
...
{(currentAccount != null && currentAccount.source == 'account') ?
  <div className="relative flex justify-center items-center"> {/* Add 'items-center' here */}
    <div className="flex flex-col items-center text-center"> {/* Add 'items-center' and 'text-center' here */}
