...
export default function Main(props) {
  ...
  return (
    <>
    {/* Page Title */}
    <h1 className="dark:text-gray-200 text-gray-800 text-3xl sm:text-3xl font-thin">
      Delegated Staking
    </h1>
    <br />
    {/* Staked Balance Notice */}
    <form className="space-y-4">
      <h1 className="dark:text-gray-200 text-gray-800 text-3xl sm:text-2xl font-semibold">
        Balance Staked: {amountCurrentlyStakedTao} Tao&nbsp;
      </h1>
      {/* Radio Buttons with the blue thing, but the styling is all messed up */}
      {/* <Stack direction="row" spacing={2} className="flex items-center justify-center dark:text-gray-200 text-gray-800 text-3xl sm:text-2xl font-thin lg:px-24 rounded-lg space-x-4">
        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
            ...
            <label for="stake-type-radio-staking"  class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
              Staking
            </label>
        </div>
        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
            ...
            <label for="stake-type-radio-staking-unstaking"  className={`bg-gray-200 dark:bg-gray-300 dark:text-gray-800 hover:bg-gray-400 dark:hover:bg-gray-400 px-4 py-2 rounded-lg ${stakeType != 'addStake' ? 'bg-gray-300 dark:bg-gray-500' : ''}`}>
              Un-Staking
            </label>
        </div>
      </Stack> */}
      {/* Staking - Unstaking Radio Buttons */}
      <div className="flex items-center justify-center dark:text-gray-200 text-gray-800 text-3xl sm:text-2xl font-thin lg:px-24 rounded-lg space-x-4">
        {/* Staking Button */}
        <label className={`bg-gray-200 dark:bg-gray-300 dark:text-gray-800 hover:bg-gray-400 dark:hover:bg-gray-400 px-4 py-2 lg:px-12 rounded-lg ${stakeType === 'addStake' ? 'bg-gray-300 dark:bg-gray-500' : ''}`}>
          <input 
            type="radio" 
            className="sr-only" 
            name="stakeType" 
        ...
        {/* Unstaking Button */}
        <label className={`bg-gray-200 dark:bg-gray-300 dark:text-gray-800 hover:bg-gray-400 dark:hover:bg-gray-400 px-4 py-2 rounded-lg ${stakeType != 'addStake' ? 'bg-gray-300 dark:bg-gray-500' : ''}`}>
          <input 
            type="radio" 
            className="sr-only" 
            name="stakeType" 
      ...
      <Stack sx={{m: 2}} spacing={2} direction="row">
        ...
        {/* If there isn't enough Tao, notify the user to avoid confusion and remove buttons otherwise show the button*/}
        {
          (fullStakeAmount < 1) && (stakeType === 'addStake') ? 
            <label htmlFor="send-to-account" className=" lg:px-12 block text-gray-700 dark:text-gray-200">
