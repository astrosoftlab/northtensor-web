  ...
  return (
    <>
      ...
      <form className="space-y-4">
        ...
        <div className="flex items-center pl-4 border border-slate-200 rounded dark:border-slate-700">
            <input 
            ...
            <label for="stake-type-radio-staking"  className="w-full py-4 ml-2 text-sm font-medium text-slate-900 dark:text-slate-300">
              Staking
            </label>
        </div>
        <div className="flex items-center pl-4 border border-slate-200 rounded dark:border-slate-700">
        ...
        <div className="flex items-center justify-center dark:text-slate-200 text-slate-800 text-3xl sm:text-2xl font-thin lg:px-24 rounded-lg space-x-4">
          {/* Staking Button */}
          <label
            className={`bg-slate-200 dark:bg-slate-300 dark:text-slate-800 hover:bg-slate-400 dark:hover:bg-slate-400 px-4 py-2 lg:px-12 rounded-lg ${
              stakeType === "addStake" ? "bg-slate-300 dark:bg-slate-500" : ""
            }`}
          >
            <input
              type="radio"
          ...
          {/* Unstaking Button */}
          <label
            className={`bg-slate-200 dark:bg-slate-300 dark:text-slate-800 hover:bg-slate-400 dark:hover:bg-slate-400 px-4 py-2 rounded-lg ${
              stakeType != "addStake" ? "bg-slate-300 dark:bg-slate-500" : ""
            }`}
          >
            <input
      ...
      <Stack sx={{ m: 2 }} spacing={2} direction="column">
        ...
        <Stack sx={{ m: 2 }} spacing={2} direction="row">
          ...
          {fullStakeAmount < 1 && stakeType === "addStake" ? (
            <label
              htmlFor="send-to-account"
              className=" lg:px-12 block text-slate-700 dark:text-slate-200"
            >
