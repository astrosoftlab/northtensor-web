...
export default function Example() {
  return (
        ...
        <li key={project.id} className="overflow-hidden rounded-xl border border-slate-200">
          ...
          <dl className="-my-3 divide-y divide-slate-100 px-6 py-4 text-sm leading-6">
            <div className="flex justify-between gap-x-4 py-3">
              <dt className="text-slate-500 dark:text-slate-100">Summary</dt>
              <dd className="text-slate-700 dark:text-slate-400">
                <p >{project.detail.summary}</p>
              </dd>
            </div>
            <div className="flex justify-between gap-x-4 py-3">
              <dt className="text-slate-500 dark:text-slate-100">Team</dt>
              <dd className="text-slate-700 dark:text-slate-400">
                <p >{project.detail.team}</p>
              </dd>
            </div>
            <div className="flex justify-between gap-x-4 py-3">
              <dt className="text-slate-500 dark:text-slate-100">Toolset</dt>
              <dd className="text-slate-700 dark:text-slate-400">
    ...
    >
      <span className="mt-2 block text-sm font-semibold text-slate-900 dark:text-slate-100">Your Project Here!</span>
    </Link>
    </ul>
  )
}
