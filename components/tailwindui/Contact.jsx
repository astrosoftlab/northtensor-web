          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-600 ">
                Don&apos;t hesitate to reach out if you&apos;re interested in
                North Tensor and Bittensor. We&apos;re happy to collaborate.
              </p>
            </div>
              ...
              <div className="rounded-2xl bg-slate-50 p-10">
                ...
                <dl className="mt-3 space-y-1 text-sm leading-6 text-slate-600">
                  <div>
                    ...
                    <dd>
                      <a
                        className="font-semibold text-[#8BAC42]"
                        href="mailto:contact@northtensor.ai"
                      >
                ...
                <dl className="mt-3 space-y-1 text-sm leading-6 text-slate-600">
                  <div>
                    ...
                    <dd>
                      <a
                        className="font-semibold text-[#8BAC42]"
                        href="mailto:andre@northtensor.ai"
                      >
                ...
                <dl className="mt-3 space-y-1 text-sm leading-6 text-slate-600">
                  <div>
                    ...
                    <dd>
                      <a
                        className="font-semibold text-[#8BAC42]"
                        href="mailto:site@northtensor.ai"
                      >
                        site@northtensor.ai
                      </a>
                    </dd>
                  ...
                  <div className="mt-1">
                    <dt className="sr-only">Detail</dt>
                    <dd>
                      For the site improvement suggestions, or if you want to
                      show up on our Built on Bittensor page.
                    </dd>
                  </div>
                </dl>
              </div>
