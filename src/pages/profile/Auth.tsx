...
import { UserContextProvider, useUser } from '@supabase/auth-ui-react/dist/components/Auth/UserContext'
import {
  EmailAuth,
  EmailAuthProps,
  ForgottenPassword,
  ...
  UpdatePassword,
  VerifyOtp
} from '@supabase/auth-ui-react/dist/components/Auth/interfaces'
import { Auth as AuthProps } from '@supabase/auth-ui-react/dist/types'
import { I18nVariables, VIEWS, en, merge } from '@supabase/auth-ui-shared'
...
function Auth({
  ...
  switch (authView) {
    ...
    case VIEWS.UPDATE_PASSWORD:
      return <UpdatePassword appearance={appearance} supabaseClient={supabaseClient} i18n={i18n} />
