    ...
    <div className="px-6 py-32 sm:px-8">
      <div className="max-w-3xl mx-auto text-base leading-7">
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in NorthTensor. This policy is not applicable to
        ...
        <p>
          ...
          in their respective advertisements and links that appear on NorthTensor, which are sent directly to
        ...
        <p>
          NorthTensor does not knowingly collect any Personal Identifiable Information from children under the age of
