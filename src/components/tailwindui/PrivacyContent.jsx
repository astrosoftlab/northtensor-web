    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-slate-700">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
          Privacy Policy for North Tensor
        </h1>
        <p className="mt-6 text-xl leading-8">
          At North Tensor, accessible from northtensor.ai, one of our main
          priorities is the privacy of our visitors.{" "}
        </p>
        <p>
          This Privacy Policy document contains types of information that is
          collected and recorded by North Tensor and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in North Tensor. This policy is not applicable
        ...
        <p>
          North Tensor follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, North Tensor uses &quot;cookies&quot;. These
        ...
        <p>
          ...
          advertising partners of North Tensor.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on North Tensor, which are sent
        ...
        <p>
          Note that North Tensor has no access to or control over these cookies
        ...
        <p>
          North Tensor&apos;s Privacy Policy does not apply to other advertisers
        ...
        <p>
          North Tensor does not knowingly collect any Personal Identifiable
