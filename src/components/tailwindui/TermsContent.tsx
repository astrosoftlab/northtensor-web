    ...
    <div className="min-h-screen px-6 py-32 bg-white lg:px-8">
      <div className="max-w-3xl mx-auto text-base leading-7 text-slate-700">
        ...
        <p className="mt-6 text-xl leading-8">
          These terms and conditions outline the rules and regulations for the use of NorthTensor&apos;s Website,
          located at northtensor.ai.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use NorthTensor
        ...
        <p>
          ...
          prevailing law of us. Any use of the above terminology or other words in the singular, plural, capitalization
        ...
        <p>
          ...
          material on NorthTensor. All intellectual property rights are reserved. You may access this from NorthTensor
        ...
        <p>
          ...
          certain areas of the website. NorthTensor does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions of NorthTensor,its agents and/or
          affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, NorthTensor shall not be liable for the Comments or for any liability,
        ...
        <p>
          NorthTensor reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant NorthTensor a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          NorthTensor; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to NorthTensor. Please include your name, your organization name,
        ...
        <p>
          No use of NorthTensor&apos;s logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>
