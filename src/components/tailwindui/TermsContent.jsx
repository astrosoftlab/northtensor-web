  ...
  return (
    <div className="min-h-screen bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-slate-700">
        <p className="text-base font-semibold leading-7 text-[#CC6B32]">
          Legal
        </p>
        ...
        <p className="mt-6 text-xl leading-8">
          ...
          use of North Tensor&apos;s Website, located at northtensor.ai.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use North Tensor if you do not agree to
        ...
        <Divider />
        <p>
          We employ the use of cookies. By accessing North Tensor, you agreed to
          use cookies in agreement with the North Tensor&apos;s Privacy Policy.{" "}
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, North Tensor and/or its licensors own the
          intellectual property rights for all material on North Tensor. All
          intellectual property rights are reserved. You may access this from
          North Tensor for your own personal use subjected to restrictions set
        ...
        <ul>
          <li className="flex gap-x-3">
            <CheckCircleIcon
              className="mt-1 h-5 w-5 flex-none text-[#CC6B32]"
              aria-hidden="true"
            />
            Republish material from North Tensor
          </li>
          <li className="flex gap-x-3">
            <CheckCircleIcon
              className="mt-1 h-5 w-5 flex-none text-[#CC6B32]"
              aria-hidden="true"
            />
            Sell, rent or sub-license material from North Tensor
          </li>
          <li className="flex gap-x-3">
            <CheckCircleIcon
              className="mt-1 h-5 w-5 flex-none text-[#CC6B32]"
              aria-hidden="true"
            />
            Reproduce, duplicate or copy material from North Tensor
          </li>
          <li className="flex gap-x-3">
            <CheckCircleIcon
              className="mt-1 h-5 w-5 flex-none text-[#CC6B32]"
              aria-hidden="true"
            />
            Redistribute content from North Tensor
          </li>
        </ul>
        ...
        <p>
          ...
          North Tensor does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of North Tensor,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, North Tensor
        ...
        <p>
          North Tensor reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant North Tensor a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of North Tensor; and (d) the
        ...
        <p>
          ...
          sending an e-mail to North Tensor. Please include your name, your
        ...
        <p>
          No use of North Tensor&apos;s logo or other artwork will be allowed
