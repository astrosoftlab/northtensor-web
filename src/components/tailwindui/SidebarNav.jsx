...
import { CodeBracketIcon, CpuChipIcon, HomeIcon, UserGroupIcon } from "@heroicons/react/24/outline"
...
const navigation = [
  { name: "Overview", href: "/resources", icon: HomeIcon },
  {
    ...
    children: [
      ...
      { name: "Staking on NorthTensor", href: "/docs/staking" },
    ],
  },
  {
    name: "Development",
  ...
  },
  {
    ...
    icon: CpuChipIcon,
    current: false,
    children: [{ name: "Getting Started", href: "/docs/miner-intro" }],
  },
]
      ...
      <nav className="flex flex-1 flex-col">
        <div className="block sm:hidden">
          ...
          >
            ...
            <p className="text-center">Resource List</p>
          </button>
          {showMenu && (
