...
function TxButton({
  ...
  const transaction = async () => {
    ...
    setStatus('Sending... Please check your browser extension and allow it.')
  ...
  return (
    <Button
      className="bg-gray-500 hover:bg-gray-600 dark:hover-bg-gray-400 text-gray-100 font-semibold py-2 px-4 rounded"
      basic
      color={color}
      style={style}
      type="submit"
